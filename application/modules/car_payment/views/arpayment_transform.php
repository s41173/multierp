...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform2" method="post" action="<?php echo $form_action_item; ?>">
		<table>
			<tr>
				...
				<td>
					<label for="titem"> Tax : </label> <br />
					<?php $js = 'class="required"'; echo form_dropdown('ctax', $tax, isset($default['tax']) ? $default['tax'] : '', $js); ?> &nbsp;
				</td>
	...
	<fieldset class="field"> <legend> Sales Return </legend>
	<form name="modul_form" class="myform" id="ajaxform2" method="post" action="<?php echo $form_action_return; ?>">
		<table>
			<tr>
				<td>  
					<label for="titem"> Transaction: SR-00 </label> <br />
					<input type="text" class="required" readonly name="treturn" id="treturn" size="5" title="Transaction Code" />
					<?php echo anchor_popup(site_url("sales_return/get_list/".$default['currency'].'/'.$venid.'/'), '[ ... ]', $atts1); ?> &nbsp;
				</td>
