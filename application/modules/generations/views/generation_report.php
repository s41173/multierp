...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> Generation List </p>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border:1px solid #000; ">
		...
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Generation </th> <th> Description </th> <th> Status </th>
		   </tr>
		    
		  <?php 
		  
		  	  function status($val)
			  { if ($val == 0){ $val = 'Non Active'; } else { $val = 'Active'; } return $val; }	
