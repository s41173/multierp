...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Academic Generation </legend>	
        ...
        <form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
         ...
         <td> <input type="text" name="tgeneration" id="tgeneration" size="8" maxlength="4" onKeyUp="checkdigit(this.value,'tgeneration');" /> </td>
                    </tr>
					...
					<tr>
                    <td colspan="2"></td> <td> <input type="submit" name="submit" class="" title="" value="SAVE" /> </td>
                    </tr>
				</table>	
			</form>		
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("generations/report"), 'PRINT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
