...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Payroll Transaction </legend>	
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("payroll_trans/add"), 'ADD NEW', $atts2); ?>
           <?php echo anchor_popup(site_url("payroll_trans/report"), 'REPORT', $atts1); ?>
           <?php echo anchor_popup(site_url("payroll_trans/export"), 'CSV - EXPORT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
