...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Warehouse </legend>	
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("warehouse/add"), 'ADD NEW', $atts2); ?>
           <?php echo anchor_popup(site_url("warehouse/report"), 'REPORT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
