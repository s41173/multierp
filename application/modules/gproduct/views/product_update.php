...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>" >
			...
			<td> <input type="text" class="" name="tname" size="45" title="Product Model"
			...
			<td> <input type="text" maxlength="5" name="tqty" id="tqtys" size="5" title="Qty" onKeyUp="checkdigit(this.value, 'tqtys')"
			value="<?php echo set_value('tqty', isset($default['qty']) ? $default['qty'] : ''); ?>" /> <br /> </td> </tr>
            
            <tr> <td> <label for="thpp"> Unit Price (HPP) </label></td> <td>:</td> 
			<td> <input type="text" maxlength="10"  name="thpp" id="thpp" size="15" title="HPP" onKeyUp="checkdigit(this.value, 'thpp')"
			value="<?php echo set_value('thpp', isset($default['hpp']) ? $default['hpp'] : ''); ?>" /> <br /> </td> </tr>
