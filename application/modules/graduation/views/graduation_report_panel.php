...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Graduation - Report </legend>
   ...
   <tr>	
   <td> <label for="cyear"> Generation </label> </td> <td>:</td>
   <td> <?php $js = 'id="cyear"'; echo form_dropdown('cyear', $year, isset($default['year']) ? $default['year'] : '', $js); ?> <br /> </td>
   </tr>	
   
   <tr>	
   <td> <label for="cyear"> Type </label> </td> <td>:</td>
   <td> <select name="cformat"> <option value="0"> Summary </option> <option value="1"> Pivot Table </option> </select> <br /> </td>
   </tr>			
				</table>
