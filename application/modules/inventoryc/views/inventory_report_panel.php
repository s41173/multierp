...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Inventory Report </legend>
	...
	<td> <?php $js = 'class=""'; echo form_dropdown('ccategory', $category, isset($default['category']) ? $default['category'] : '', $js); ?> </td>
	</tr>
    
    <tr>	
	<td> <label for="croom"> Room </label> </td> <td>:</td>
	<td> <?php $js = 'class=""'; echo form_dropdown('croom', $category, isset($default['room']) ? $default['room'] : '', $js); ?> </td>
	</tr>
