...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> Uniform Cost Report </p>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border:1px solid #000; ">
		...
		<table border="0" width="100%">
		   <tr>
  	       <th> No </th> <th> Department </th> <th> Male </th> <th> Female </th> <th> Practice </th> <th> Scout </th> <th> Additional </th>
		   </tr>
			  ...
			  if ($results)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\" align=\"right\">".number_format($res->m)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->f)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->practice)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->scout)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->additional)."</td>
				   </tr>";
				   $i++;
				}
			  }  
