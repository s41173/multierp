...
<style media="all">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
			...
			$('#jqxgrid').jqxGrid({ pagesizeoptions: ['100', '500', '1000', '2000', '3000', '4000', '5000']}); 
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	      <h4> <?php echo isset($company) ? $company : ''; ?> <br> APC - Report Category </h4>
	   </div>
	</center>
...
<table id="table" border="0">
 <thead>
 <tr>
 <th>No</th> <th>Date</th> <th>Order No</th> <th> Code </th> <th>Category</th> <th>Notes</th> <th>Acc</th> 
  ...
  <?php 	
      ...
      if ($aps)
      {
        ...
        {	
           ...
           <td class=\"strongs\" align=\"center\">DJC-00".$ap->no."</td>
           <td class=\"strongs\" align=\"left\">".$acc->get_code($ap->account).' : '.$acc->get_name($ap->account)."</td>
