...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("apc/add"), 'CREATE NEW', $atts); ?>
		   <?php echo anchor(site_url("apc/report"), 'REPORT', $atts2); ?>
           <?php echo anchor_popup(site_url("apc/cash_ledger"), 'CASH LEDGER', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
    
    <fieldset class="field"> <legend> AP-Transaction Chart </legend>
