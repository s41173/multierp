...
<title> AR - Tuitions - TRJ-00<?php echo isset($pono) ? $pono : ''; ?></title>
<style media="all">
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center;"> <?php echo $pname; ?> <br> TUITION RETURN </h2> 
    ...
    <div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> Academic Year </td> <td>:</td> <td> <?php echo $finance_year; ?> </td> </tr>
	...
	<div style="margin:3px 0 0 0; border-bottom:0px dotted #000;">
		...
		<table class="product">
		 ...
		 <tr> <th> Department </th>  <th> Student </th> <th> Month </th> <th> Amount </th> </tr>
		...
		<tr> <td></td> <td class="right"> <b> Total : </b> </td> <td></td>
		...
		<style>
			...
			<table border="0" class="sig">
				<tr> <td> Direktur </td> <td> Accounting </td> <td> Kasir <br> (<?php echo $user; ?>) </td> <td> ___________________ </td> </tr>
			</table>
		</div>
