...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> AR - Tuition Fee </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
					
					<td> <label for=""> Academic Year : </label> <br />
					     <?php $js = 'id="cyear"'; echo form_dropdown('cyear', $year, isset($default['year']) ? $default['year'] : '', $js); ?>
					</td> 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("ar_tuitions/add"), 'ADD TANSACTION', $atts1); ?>
		   <?php echo anchor_popup(site_url("ar_tuitions/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
