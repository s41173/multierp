...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> AR - Tuition Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
            ...
            <tr>	
			<td> <label for="tname"> Department </label> </td> <td>:</td>
			...
			<td> <?php $js = 'class=""'; echo form_dropdown('cyear', $year, isset($default['year']) ? $default['year'] : '', $js); ?> </td>
			</tr>
