		...
		<table>
			<tr>
				<td>  
					...
					<?php echo anchor_popup(site_url("nsales/get_list/".$default['currency'].'/'.$venid.'/'), '[ ... ]', $atts1); ?> &nbsp;
				</td>
				...
				<td>
					...
					<input type="text" disabled="disabled" size="15" name="tamount" id="tamount" onKeyUp="checkdigit(this.value, 'tamount')" /> &nbsp;
				</td>
                
                <td>
					<label for="ttax"> Tax : </label> <br />
					<input type="text" disabled="disabled" size="15" name="ttax" id="ttax" onKeyUp="checkdigit(this.value, 'ttax')" /> &nbsp;
				</td>
                
                <td>
					<label for="ttax"> Cost : </label> <br />
					<input type="text" disabled="disabled" size="15" name="tcost" id="tcost" onKeyUp="checkdigit(this.value, 'tcost')" /> &nbsp;
				</td>
