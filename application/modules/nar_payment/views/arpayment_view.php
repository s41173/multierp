...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> AR - Payment </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
					
					<td> <label for="tname">NO : CR-00</label> <br /> <input type="text" class="" id="tno" name="tno" size="8" title="No" 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("nar_payment/add"), 'CREATE NEW PAYMENT', $atts); ?>
		   <?php echo anchor_popup(site_url("nar_payment/report"), 'REPORT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
