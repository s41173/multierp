...
<title> AP-Payment - CR-00<?php echo isset($pono) ? $pono : ''; ?></title>
<style media="all">
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
            ...
            <tr> <td> </td> <td> </td> <td> <?php echo $checkno; ?> </td> </tr>
		</table>
	</div>
	
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> </td> <td> </td> <td> <p style="font-size:14px; font-weight:bold;"> NCR-00<?php echo $pono; ?> </p> </td> </tr>
	...
	<div style="margin:3px 0 0 0; border-bottom:0px dotted #000;">
		...
		<table class="product">
		 ...
		 <tr> <th> No </th>  <th> Desc </th> <th> Amount </th> <th> Tax </th> <th> Cost </th> <th> Balance </th> </tr>
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						...
						<td class=\"right\"> ".number_format($res->cost)." </td> 
						<td class=\"right\"> ".number_format($res->amount+$res->cost+$res->tax)." </td>  
					 </tr>
