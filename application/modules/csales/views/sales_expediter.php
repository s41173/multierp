...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<div style="width:300px; border:0px solid red; float:left;">
		<table style="font-size:12px;">
		    <tr> <td> No. SO </td> <td>:</td> <td> <?php echo $pono; ?> </td> </tr>
			<tr> <td> Tgl </td> <td>:</td> <td> <?php echo $podate; ?> </td> </tr>
			<tr> <td> Customer </td> <td>:</td> <td> <?php echo $customer; ?> </td> </tr>
		</table>
	</div>
	...
	<div style="width:375px; border:0px solid red; float:right;">
		<table style="font-size:12px;">
			...
			<tr> <td> Alamat Pengiriman </td> <td>:</td> <td> <?php echo $c_address.'<br>'.$c_zip.' '.$c_city; ?> </td> </tr>
		</table>
	</div>
	...
	<div style="margin:10px 0 0 0; border-solid:0px dotted #000;">
		...
		<table class="product">
		 ...
		 <tr> <th> No </th>  <th> Keterangan </th> </tr>

		 <tr> <td> 1 </td> <td class="left"> <?php echo $notes; ?> </td>  </tr> 
		...
		<style>
		  ...
		  .sig td{ width:170px;}
			...
			<table border="0" class="sig">
				<tr> <td> <?php echo $customer; ?> </td>  <td> <?php echo $p_name; ?> </td> </tr>
