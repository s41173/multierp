...
function calculate_aid()
{
	...
	var aidtype = $("#caid").val();
	if (aid > 0){ document.getElementById("caid").value = '1'; }else { document.getElementById("caid").value = '0'; }
}
...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Create - Tuition Transaction </legend>
...
value="<?php echo set_value('tbos', isset($default['bos']) ? $default['bos'] : '0'); ?>" onKeyUp="checkdigit(this.value,'tbos'); calculate_aid()" /> </td>
					</tr> 
...
value="<?php echo set_value('tfound', isset($default['found']) ? $default['found'] : '0'); ?>" onKeyUp="checkdigit(this.value,'tfound'); calculate_aid()" /> &nbsp;
