...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Tuition Transaction - Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
				<table>
				
   <tr>	
   <td> <label for="cperiod"> Financial Year </label> </td> <td>:</td>
   <td> <?php $js = 'id=""'; echo form_dropdown('cperiod', $period, isset($default['period']) ? $default['period'] : '', $js); ?> <br /> </td>
   </tr>
  ...
  <img src="<?php echo base_url();?>/jdtp-images/cal.gif" onclick="javascript:NewCssCal('d2','yyyymmdd')" style="cursor:pointer"/> &nbsp; <br />
    ...
    <option value="3">III</option> </select> - <div style="float:right; margin-left:2px;" id="feebox"> </div> <br /> </td>
    </tr>
    ...
    <tr>	
    <td> <label for="cuser"> User </label> </td> <td>:</td>
    <td>  
    <?php $js = 'id=""'; echo form_dropdown('cuser', $usercombo, isset($default['user']) ? $default['user'] : '', $js); ?>  &nbsp; </td>
    </tr>
    
    <tr>	
    <td> <label for="creport"> Report Type </label> </td> <td>:</td>
    <td>  
    <select name="creport"> 
    <option value="0"> Static Table </option> 
