...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> TUITION - RECEIPT OF PAYMENT </h2> 
    <div style="clear:both; "></div> 
	
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Paid To </td> <td>:</td> <td> <?php echo $name; ?> </td> </tr>
			<tr> <td> Financial Year </td> <td>:</td> <td> <?php echo $year; ?> </td> </tr>
            <tr> <td> Tuition Type </td> <td>:</td> <td> <?php echo $tuition; ?> </td> </tr>
	...
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> Transcode </td> <td>:</td> <td> <?php echo $transcode; ?> </td> </tr>
	...
	<div style="margin:3px 0 0 0; border-bottom:0px dotted #000;">
        ...
        <tr> <td> 4 </td> <td class="left"> Practical </td> <td class="right"> <?php echo number_format($practical); ?>,- </td> </tr>
        <tr> <td> 5 </td> <td class="left"> Other Cost </td> <td class="right"> <?php echo number_format($cost); ?>,- </td> </tr>
        <tr> <td> 6 </td> <td class="left"> Aid (-) </td> <td class="right"> <?php echo number_format($aid); ?>,- </td> </tr>
		 
		<tr> <td></td> <td class="right"> <b> Balance : </b> </td>
		...
		<style>
			...
			<table border="0" class="sig">
				<tr> <td> </td> <td> </td> <td> Paid By : </td> <td> Received By : </td> </tr>
