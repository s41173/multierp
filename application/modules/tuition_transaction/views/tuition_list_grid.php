        ...
        $(document).ready(function () {
           // var url = "<?php //echo $source;?>";
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  { text: 'Period', dataField: 'Period', width: 200 },
				  { text: 'Fee', dataField: 'Fee', width: 200 },
				  { text: 'Name', dataField: 'Name', width: 200 },
				  { text: 'Nis', dataField: 'Nis', width: 150 },
...
<body id='default'>
    ...
    <thead> <tr> <th> Period </th> <th> Fee </th> <th> Name </th> <th> Nis </th> <th> Type </th> </tr> </thead>
    ...
    <?php
		...
		{
			function type($val)
			{  if ($val == 0){ return 'B'; }elseif ($val == 1){ return 'N'; }else{ return 'F'; } }
