...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor(site_url("product/opening"), 'OPENING BALANCE', $atts2); ?>
		   <?php echo anchor(site_url("brand"), 'BRAND LIST', $atts2); ?>
           <?php echo anchor(site_url("category"), 'CATEGORY LIST', $atts2); ?>
           ...
           <?php echo anchor_popup(site_url("product/chart"), 'CHART', $atts3); ?>
