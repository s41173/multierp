...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>" >
			...
			<td> <input type="text" class="required" name="tname" readonly size="45" title="Product Model"
			value="<?php echo set_value('tname', isset($default['name']) ? $default['name'] : ''); ?>" /> <br /> </td> </tr>
			

			<tr> <td> <label for="tqty"> Open - Qty </label></td> <td>:</td> 
            ...
            <tr> <td> <label for="tucost"> Open - Unit Costs </label></td> <td>:</td> 
			<td> <input type="text" maxlength="10" name="tucost" id="tucost" size="15" title="Unit" 
