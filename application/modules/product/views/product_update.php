...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>" >
            ...
            <tr> <td> <label for="tname"> Model </label></td> <td>:</td> 
			<td> <input type="text" name="tmodel" size="20" title="Product Model"
			value="<?php echo set_value('tmodel', isset($default['model']) ? $default['model'] : ''); ?>" /> <br /> </td> </tr>
						
			<tr> <td> <label for="tname"> Name </label></td> <td>:</td> 
			<td> <input type="text" class="required" name="tname" size="45" title="Product Name"
