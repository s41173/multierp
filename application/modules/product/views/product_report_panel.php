...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Product - Stock Card </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" onsubmit="" >
			...
			<td> <?php $js = 'class="required"'; echo form_dropdown('ccur', $currency, isset($default['cur']) ? $default['cur'] : '', $js); ?> </td>
			</tr>
            ...
            <tr>	
			<td> <label for="ctype"> Product Type </label> </td> <td>:</td>
			<td> <select name="cptype">
                 <option value=""> -- </option>
			...
			<td> <select name="ctype"> <option value="0"> Inventory </option> <option value="2"> Inventory - Pivottable </option> <option value="1"> Stock Card </option> </select> <br /> </td>
			</tr>			
			...
			<p>
				...
				<input type="button" class="button" value="CANCEL" onclick="closing();" />
			</p>
			</form>			  
	</fieldset>
</div>
