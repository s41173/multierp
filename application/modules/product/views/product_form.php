...
<div id="webadmin">
    ...
    <p class="message"> Charging initial balance can only be done at the beginning of the period. </p>
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>" >
            ...
            <tr> <td> <label for="tmodel"> Model </label></td> <td>:</td> 
			<td> <input type="text" class="" name="tmodel" size="20" title="Product Model" /> <br /> </td> </tr>
            			
			<tr> <td> <label for="tname"> Name (*)</label></td> <td>:</td> 
			<td> <input type="text" class="" name="tname" size="45" title="Product Name" /> <br /> </td> </tr>
	...
	<td> <input type="text" readonly maxlength="5" id="tqtys" name="tqty" size="3" title="Qty" onKeyUp="checkdigit(this.value, 'tqtys')" value="0" /> </td> </tr>
    
    <tr> <td> <label for="tbuying"> Buying Price </label></td> <td>:</td> 
			<td> <input type="text" maxlength="10" name="tbuying" id="tbuying" size="15" title="Buying" onKeyUp="checkdigit(this.value, 'tbuying')"
			...
			<td> <input type="text" maxlength="10" name="tucost" id="tucost" size="15" title="Unit" onKeyUp="checkdigit(this.value, 'tucost')"
