...
<div id="webadmin">
	     ...
	     <td> <input type="text" class="required" readonly="readonly" name="tno" id="tno" size="4" title="Name" onKeyUp="checkdigit(this.value, 'tno')"
		       value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
					...
					<tr>
						...
						<td>  <input type="text" class="" name="tdocno" size="20" title="Doc No"
	...
	<option value="pettycash" <?php echo set_select('cacc', 'pettycash', isset($default['acc']) && $default['acc'] == 'pettycash' ? TRUE : FALSE); ?> /> Petty Cash </option>
     ...
     <td> 
	 <textarea name="tdesc" class="required" title="Description" cols="45" rows="3"><?php echo set_value('tdesc', isset($default['desc']) ? $default['desc'] : ''); ?></textarea> &nbsp; <br /> </td></tr>	
