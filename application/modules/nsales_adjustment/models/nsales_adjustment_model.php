...
class Nsales_adjustment_model extends CI_Model
{
    ...
    function get_last_nsales_adjustment($limit, $offset)
    {
    ...
    function get_nsales_adjustment_by_id($uid)
    {
        $this->db->select('id, no, dates, sales_no, docno, currency, user, notes, desc, total, dp, approved, log');
        $this->db->from($this->table);
        $this->db->where('id', $uid);
    ...
    function get_nsales_adjustment_by_no($uid)
    {
        $this->db->select('id, no, dates, sales_no, docno, currency, user, notes, desc, total, dp, approved, log');
        $this->db->from($this->table);
