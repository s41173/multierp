...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Non Tax Sales Adjustment <br> Report Details </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Currency </th> <th> Code </th> <th> Sales </th> <th> Notes </th> <th> Amount </th> <th> Log </th> 
		   </tr>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\"> NSAJ-00".$res->no."</td>
					   <td class=\"strongs\"> NSO-00".$res->sales_no."</td>
   					   <td class=\"strongs\">".$res->notes."</td>
					   <td class=\"right\">".number_format($res->total)."</td> 
