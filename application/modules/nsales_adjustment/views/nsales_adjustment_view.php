...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Non Tax Sales Adjustment </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
					
					<td> <label for="tname"> NSAJ-00</label></td> <td></td> <td><input type="text" class="" id="tno" name="tno" size="5" title="No" 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("nsales_adjustment/add"), 'CREATE NEW', $atts); ?>
		   <?php echo anchor_popup(site_url("nsales_adjustment/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
