...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Control </legend>
	    <form name="modul_form" class="myform" id="ajaxform3" method="post" action="<?php echo $form_action; ?>">
			...
			<td> <?php $js = 'class="required"'; echo form_dropdown('ccategory', $category, isset($default['category']) ? $default['category'] : '', $js); ?> &nbsp; </td>
                ...
                <tr>
                    ...
                    <td> <input type="text" class="required" readonly="readonly" name="tname" size="35" title="Desc"
