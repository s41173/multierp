...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> Student's Grade Report </p>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border:1px solid #000; ">
		...
		<table border="0" width="100%">
		   <tr>
  	       <th> No </th> <th> Department </th> <th> Level </th> <th> Faculty </th> <th> Name </th> <th> Capacity </th>
           <th> Filled </th> <th> Fee Type </th> <th> Instructor </th>
		   </tr>
			  ...
			  if ($results)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\" align=\"center\">".faculty($res->faculty_id)."</td>
					   <td class=\"strongs\" align=\"center\">".$res->name."</td>
					   <td class=\"strongs\" align=\"center\">".$res->capacity."</td>
					   <td class=\"strongs\" align=\"center\">".$res->filled."</td>
					   <td class=\"strongs\" align=\"left\">".fee($res->fee)."</td>
					   <td class=\"strongs\" align=\"left\">".$res->instructor."</td>
				   </tr>";
				   $i++;
				}
			  }  
