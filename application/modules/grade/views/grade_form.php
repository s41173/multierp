...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Add - Grade </legend>
...
<option value="XII"<?php echo set_select('cgrade', 'XII', isset($default['grade']) && $default['grade'] == 'XII' ? TRUE : FALSE); ?> /> XII </option>
                         ...
                         <div style=" float:left; margin-left:5px; margin-right:5px;" id="facultybox"></div>
                         <input style="margin-left:5px;" type="text" name="tno" size="1" required>  </td>   
					</tr> 
        ...
        <td> <select name="cstts"> <option value="1"> Y </option> <option value="0"> N </option> </select> </td> 
        </tr> 
        ...
        <td> <input type="text" name="tcapacity" id="tcapacity" size="3" title="Capacity" onKeyUp="checkdigit(this.value,'tcapacity');" /> </td> 
        </tr> 
        
        <tr>                 
        <td> <label for="tdesc"> Description </label> </td> <td>:</td> 
        <td> <textarea name="tdesc" rows="3"></textarea>
        </td> 
        </tr> 
