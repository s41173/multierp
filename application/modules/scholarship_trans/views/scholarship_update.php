...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>" >
      ...
      <td> <?php $js = 'id="ctype"'; echo form_dropdown('cscholarship', $type, isset($default['scholar']) ? $default['scholar'] : '', $js); ?> - 
      ...
      <td> <input type="text" class="required" id="tnote" name="tnote" size="42" title="Note"
