...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Product Assembly </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
					
					<td> <label for="tname">NO : AP-00</label> <br /> <input type="text" class="" id="tno" name="tno" size="8" title="No" 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("assembly/add"), 'CREATE NEW', $atts); ?>
		   <?php echo anchor_popup(site_url("assembly/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
