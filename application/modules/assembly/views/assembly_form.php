...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Create New Product Assembly </legend>
				...
				<table>
					...
					<tr>	
	                    ...
	                    <td> <input type="text" class="required" readonly="readonly" name="tno" id="tno" size="4" title="Name" onkeyup="checkdigit(this.value, 'tno')"
		                      value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> 
						</td>
					</tr>
			...
			<tr>	
			  ...
			  <td> <?php $js = 'class="required"'; echo form_dropdown('ccurrency', $currency, isset($default['currency']) ? $default['currency'] : '', $js); ?> &nbsp; <br /> </td>
					...
					<tr>	
						 ...
						 <td>  
						   <input type="text" name="tproject" readonly="readonly" id="titem" title="Project" size="5" /> 
					...
					<tr>	
						 ...
						 <td>  
						   <input type="text" name="tproduct" readonly="readonly" id="tproduct" title="Product" size="20" class="required" /> 
