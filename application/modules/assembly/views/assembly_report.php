...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Product Assembly Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Order No </th> <th> Product </th> <th> Qty </th> <th> Total </th>
		   </tr>
		  ...
		  <?php 
			  ...
			  if ($assemblys)
			  {
				foreach ($assemblys as $res)
				{	
				   echo " 
				   <tr> 
				       <td class=\"strongs\">".$i."</td> 
					   <td class=\"strongs\">".tgleng($res->dates)."</td> 
					   <td class=\"strongs\"> AP-00".$res->no."</td> 
					   <td class=\"strongs\">".$res->product."</td>
					   <td class=\"strongs\">".$res->qty.' '.$res->unit."</td> 
					   <td class=\"strongs\" align=\"right\">".number_format($res->total)."</td> 
				   </tr>";
				   $i++;
				}
			  }  
