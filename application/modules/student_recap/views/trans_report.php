     ...
     <script type="text/javascript">
        $(document).ready(function () {
			...
			$("#bexport").click(function() {
				...
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Student-Recapitulation-Trans'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Student-Recapitulation-Trans'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Student-Recapitulation-Trans'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Student-Recapitulation-Trans'); }
			});
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> Student Transaction Recapitulation - Report </p>
    ...
    <option value="3"> CSV </option> 
		...
		<table border="0" id="table" width="100%">
           ...
           <thead 
		   <tr> <th> No </th> <th> Date </th> <th> Department </th> <th> Student </th> <th> Grade </th> <th> Type </th> <th> Qty </th> </tr>
           </thead>
		  ...
		  <?php 
			  ...
			  function grade($val) { $gr = new Grade_lib(); $res = $gr->get_name($val); return $res; }
  			  function student($val) { $gr = new Student_lib(); $res = $gr->get_name($val); return $res; }
			  ...
			  if ($results)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\" align=\"center\">".student($res->student_id)."</td>
