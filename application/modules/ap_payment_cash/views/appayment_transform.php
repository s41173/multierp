...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
			   ...
			   <td>  <input type="text" class="required" readonly="readonly" name="ttype" size="15" title="Type"
			         value="<?php echo set_value('ttype', isset($default['type']) ? $default['type'] : ''); ?>" /> &nbsp; <br /> </td>
			       </tr>
		...
		<table>
			<tr>
				<td>  
					...
					<input type="text" class="required" readonly="readonly" name="titem" id="titem" size="5" title="Transaction Code" />
					<?php echo anchor_popup(site_url("ap/get_list/".$default['currency'].'/'.$default['acc'].'/'.$venid.'/'), '[ ... ]', $atts1); ?> &nbsp;
				</td>
