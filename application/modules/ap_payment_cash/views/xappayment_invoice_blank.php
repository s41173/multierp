...
<div style="width:20.5cm; font-family:Arial, Helvetica, sans-serif; font-size:12px; border:0px solid red; height:10.5cm;">
	...
	<div style="width:260px; border:0px solid red; float:right; margin:1.8cm 0 0 0;">
	...
	<div style="margin:1.3cm 0 0 0; border:0px dotted #000;">
		...
		<div style="float:left; width:600px; border:0px solid #000; margin:0.2cm 0 5px 2cm;">  
