...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					...
					<tr> <td> <label for="rtype">Type</label> </td> <td>:</td> 
<td> Tax <input name="rtype" class="required" type="radio" value="1" <?php echo set_radio('rtype', '1', isset($default['type']) && $default['type'] == '1' ? TRUE : FALSE); ?> /> 
   Non Tax <input name="rtype" class="required" type="radio" value="0" <?php echo set_radio('rtype', '0', isset($default['type']) && $default['type'] == '0' ? TRUE : FALSE); ?> />
						  <br/> 
					   </td> 
				    </tr>
