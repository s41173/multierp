...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> AP - General Payment </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
					
					<td> <label for="tname"> CG-00 : </label> <br /> <input type="text" class="" id="tno" name="tno" size="5" title="No" 
				...
				<!--		<a class="refresh" id="tombol" href="<?php //echo site_url("vendor/get_list/"); ?>"> [ ... ] </a> -->
					...
					<td> <label for="cacc"> &nbsp; Acc </label> <br />
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("ap_payment_cash/add"), 'CREATE NEW PAYMENT', $atts); ?>
		   <?php echo anchor_popup(site_url("ap_payment_cash/report"), 'REPORT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
