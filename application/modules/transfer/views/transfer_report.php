...
<link rel="stylesheet" href="<?php echo base_url().'js/jxgrid/' ?>css/jqx.base.css" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
			...
			{
				var site = "<?php echo site_url('transfer/invoice/');?>";
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
           ...
           <thead>
		   <tr>
 	       <th> No </th> <th> Code </th> <th> Date </th> <th> Cur </th> <th> From-To </th> <th> Balance </th> <th> Log </th> 
		   </tr>
           </thead>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\"> TR-0".$res->no."</td> 
