...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> NAR - Installment </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
					
					<td> <label for="tname"> NSO-00 </label></td> 
					<td>
						<input type="text" name="tsales" id="titem" size="5" title="Sales" onkeyup="checkdigit(this.value, 'titem')" />
				  	    <?php echo anchor_popup(site_url("nsales/get_list/"), '[ ... ]', $atts1); ?>
					</td> 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("nar_installment/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
