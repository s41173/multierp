...
class Nar_installment_model extends CI_Model
{
    ...
    function get_last_nar_installment($limit, $offset)
    {
        $this->db->select('id, no, dates, nsales_no, nar_payment, amount');
    ...
    function get_nar_installment_by_id($uid)
    {
        $this->db->select('id, no, dates, nsales_no, nar_payment, amount');
        $this->db->from($this->table);
        $this->db->where('id', $uid);
    ...
    function get_nar_installment_by_no($uid)
    {
        $this->db->select('id, no, dates, nsales_no, nar_payment, amount');
        $this->db->from($this->table);
...
//    =========================================  REPORT  =================================================================
    ...
    {
        $this->db->select("$this->table.id, $this->table.no, $this->table.dates, $this->table.nsales_no, $this->table.amount, nsales.currency, nsales.p2");
