...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Sales Order <br> Repository Report </h4>
	   </div>
	</center>
	...
	<div style="border:0px solid red; float:right; margin:15px 0px 0px 0px;">
	   <fieldset> <legend>Summary</legend>
			<table class="tablesum">			
				...
				<tr> <td> Discount </td> <td> : </td> <td align="right"> <?php echo number_format($discount); ?> </td> </tr>
				...
				<tr> <td> Sales Total </td> <td> : </td> <td align="right"> <?php echo number_format($ptotal); ?> </td> </tr>
