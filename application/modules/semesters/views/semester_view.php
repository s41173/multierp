        ...
        <form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
				<table>
                    ...
                    <tr>
                        ...
                        <td> <input type="text" name="tsemester" id="tsemester" size="8" maxlength="1" 
                             onKeyUp="checkdigit(this.value,'tsemester');" /> </td>
                    </tr>
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("semesters/report"), 'PRINT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
