...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Stock Adjustment Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
				<table>
                    ...
                    <tr>
                    <td> <label for="tstart"> Type </label> </td> <td>:</td> 
                    <td> <select name="ctype"> <option value="0"> Summary </option> <option value="1"> Details </option> </select>
                    <input type="submit" name="submit" class="button" title="SUBMIT" value=" SUBMIT " />  </td>				
                    </tr>
