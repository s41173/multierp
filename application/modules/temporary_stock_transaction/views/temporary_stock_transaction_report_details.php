...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Temporary Stock Transaction - Report Details </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Type </th> <th> Product </th> <th> Qty </th> <th> Staff </th> <th> Log </th> 
		   </tr>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\"> TSTR-00".$res->id."</td>
   					   <td class=\"strongs\">".$res->type."</td> 
					   <td class=\"strongs\">".$res->pname."</td>
