	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					...
					<td> <label for="tname"> Product : </label> <br /> 
					    <input type="text" class="" readonly="readonly" name="tproduct" id="tproduct" size="25" title="Name" /> &nbsp;
					...
					<td> <label for="ctype"> Type </label> <br />
					     <select name="ctype"> <option selected="selected" value=""> -- All -- </option> <option value="in"> IN </option> 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("temporary_stock_transaction/add"), 'CREATE NEW', $atts); ?>
		   <?php echo anchor_popup(site_url("temporary_stock_transaction/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
