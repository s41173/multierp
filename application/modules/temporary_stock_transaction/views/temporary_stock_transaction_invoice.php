...
<title> Temporary Stock Transaction - TSTR-00<?php echo isset($no) ? $no : ''; ?></title>
...
<style type="text/css" media="all">
	...
	.clear{ clear:both;}
	#tablebox{ height:2.45cm; width:20cm; border:0pt solid red; float:left; margin:0.1cm 0 0 0.4cm;}
...
<div id="container">
	...
	<div id="venbox">
		<table width="100%" style="font-size:1em; margin:0; text-align:left;">
		    <tr> <td> No. TSTR </td> <td>:</td> <td> <p style="padding:0; margin:0; font-weight:bold; font-size:1.5em; "> <?php echo '00'.$no; ?> </p> </td> </tr>
			<tr> <td> Tanggal </td> <td>:</td> <td> <?php echo $podate; ?> </td> </tr>
			<tr> <td> Jenis </td> <td>:</td> <td> <?php echo $type; ?> </td> </tr>
		</table>
	</div>
	...
	<div id="titbox"> 
		<p style="padding:0; margin:0 0 0 5cm; font-weight:bold; font-size:1.3em; text-align:left;"> BON TRANSAKSI BARANG - SEMENTARA </p>
	</div>
...
<tr> 
<th class="no"> No </th> <th class="name"> Nama Barang </th> <th class="unit"> Qty </th> <th class="desc"> Staff </th> 
</tr>		

<?php
		 	
     echo " <tr>  <td class=\"no\"> 1 </td> <td class=\"name\"> ".$product." </td>  <td class=\"unit\"> ".$qty." </td> <td class=\"desc\">".$staff."</td> </tr> ";
