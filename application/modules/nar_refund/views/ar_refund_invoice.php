...
<title> Customer Credit Refund - RF-00<?php echo isset($pono) ? $pono : ''; ?></title>
<style media="all">
...
<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> BUKTI PENGEMBALIAN CREDIT - <?php echo $acc; ?> - Non Tax </h2> 
<div style="clear:both; "></div> 
	
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Kepada </td> <td>:</td> <td> <?php echo $customer; ?> </td> </tr>
			...
			if ($items)
			{
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						<td> ".$i." </td>
						<td class=\"left\"> NSOV-00".$res->no." - NSO-00".$res->nsales_no."/ NCR-00".$res->nar_payment."&nbsp; </td> 
						<td class=\"right\"> ".number_format($res->over)." </td>  
					 </tr>
