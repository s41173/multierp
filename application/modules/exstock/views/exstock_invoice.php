...
<div id="container">
	...
	<div id="venbox">
		<table width="100%" style="font-size:1em; margin:0; text-align:left;">
		    <tr> <td> No. EX </td> <td>:</td> <td> <p style="padding:0; margin:0; font-weight:bold; font-size:1.5em; "> <?php echo '00'.$no; ?> </p> </td> </tr>
	...
	<div id="titbox"> 
		<p style="padding:0; margin:0 0 0 5cm; font-weight:bold; font-size:1.3em; text-align:left;"> BON PERGANTIAN BARANG (EXCHANGE) </p>
	</div>
...
<tr> 
<th class="no"> No </th> <th class="name"> Nama Barang </th> <th class="unit"> Disetujui </th> <th class="desc"> Keterangan / Pemakaian </th> 
</tr>		
