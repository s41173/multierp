...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
	     ...
	     <td> <input type="text" class="required" readonly="readonly" name="tno" size="4" title="No" value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
					...
					<tr>
						<td> <label for="tstaff"> Vendor </label> </td>  <td>:</td>
						<td>  <input type="text" readonly="readonly" name="tvendor" size="35" title="Vendor"
						      value="<?php echo set_value('tvendor', isset($default['vendor']) ? $default['vendor'] : ''); ?>" /> &nbsp; <br /> </td>
					</tr>
					...
					<tr>	
						<td> <label for="ttype"> Type </label> </td> <td>:</td>
	                    <td> <input type="text" readonly="readonly" name="ttype" size="4" title="Type" value="<?php echo isset($type) ? $type : ''; ?>" /> &nbsp; <br /> </td>
					</tr>	
					
					<tr>	
					<td> <label for="tuser"> Ref : Exstock - Out </label> </td> <td>:</td>
	                <td> <input type="text" readonly="readonly" name="tref" size="10" title="User" value="<?php echo isset($ref) ? $ref : ''; ?>" /> &nbsp; <br /> </td>
					</tr>				
		...
		<table>
			<tr>				
				<td> <label for="tproduct"> Product </label>  <br />
				     <input type="text" class="required" readonly="readonly" name="tproduct" id="tproduct" size="35" title="Name" /> &nbsp;
