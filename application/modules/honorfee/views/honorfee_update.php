...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Update - Employee Honor </legend>
    <table>
     
	<form name="modul_form" id="ajaxform" class="myform" method="post" action="<?php echo $form_action; ?>">
			
         <tr>
         <td> <label for="ttype"> Employee </label> </td> <td>:</td>
         <td> <input type="text" readonly name="ttype" size="5" title="Name"
              value="<?php echo set_value('ttype', isset($default['type']) ? $default['type'] : ''); ?>" />
         </td>
         </tr>
                     				
		 <tr>
         <td> <label for="cdept"> Department </label> </td>  <td>:</td>
         <td> <input type="text" readonly name="tdept" size="10" 
