...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Employee Honor </legend>	
    	
        <form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
                                    
            <td> <label for="tname"> Time Work : </label> <br />
                 <select name="ctype">
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("honorfee/add"), 'ADD NEW', $atts2); ?>
           <?php echo anchor_popup(site_url("honorfee/report"), 'REPORT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
