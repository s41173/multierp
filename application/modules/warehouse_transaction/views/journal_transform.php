	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
		 ...
		 <td> <input type="text" class="required" readonly="readonly" name="tno" size="4" title="Name" value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
					...
					<tr>	
						 ...
						 <td>  
						   <input type="Text" name="tdate" id="d1" title="Invoice date" size="10" class="required" readonly="readonly"
			...
			<td> <input type="text" name="tcur" readonly="readonly" size="10" title="Currency" 
	...
	<fieldset class="field" style="float:left; margin-left:15px;"> <legend> Payment Details </legend>
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" id="tdp" name="tdp" disabled="disabled" readonly="readonly" size="10" title="Down Payment" 
			...
			<tr>
				...
				<td><input type="text" id="tpj" name="tpj" disabled="disabled" readonly="readonly" size="10" title="Purchase Journal" 
			...
			<tr>
				...
				<td><input type="text" id="tsj" name="tsj" disabled="disabled" readonly="readonly" size="10" title="Sales Journal" 
			...
			<tr>
				...
				<td><input type="text" id="tds" name="tds" disabled="disabled" readonly="readonly" size="10" title="Sales Down Payment" 
					value="<?php echo set_value('tds', isset($default['ds']) ? $default['ds'] : '0'); ?>" onKeyUp="checkdigit(this.value, 'tds')" /> <br />  </td> 
			</tr>
			
			<tr>
				<td> <label for="tsj"> NSJ - Non Tax Sales Journal </label></td> <td>:</td> 
				<td><input type="text" id="tsj" name="tsj" disabled="disabled" readonly="readonly" size="10" title="Non Tax Sales Journal" 
					value="<?php echo set_value('tsj', isset($default['nsj']) ? $default['nsj'] : '0'); ?>" onKeyUp="checkdigit(this.value, 'tds')" /> <br />  </td> 
			</tr>
			
			<tr>
				<td> <label for="tnds"> NDS - Non Tax Sales Down Payment </label></td> <td>:</td> 
				<td><input type="text" id="tnds" name="tnds" disabled="disabled" readonly="readonly" size="10" title="Non Tax Sales Down Payment" 
					value="<?php echo set_value('tnds', isset($default['nds']) ? $default['nds'] : '0'); ?>" onKeyUp="checkdigit(this.value, 'tnds')" /> <br />  </td> 
			</tr>
			
			<tr>
				<td> <label for="tcd"> CD - Account Payable </label></td> <td>:</td> 
				<td><input type="text" id="tcd" name="tcd" disabled="disabled" readonly="readonly" size="10" title="Account Payable" 
			...
			<tr>
				...
				<td><input type="text" id="tcg" name="tcg" disabled="disabled" readonly="readonly" size="10" title="Account Payable (Cash)" 
			...
			<tr>
				...
				<td><input type="text" id="tcr" name="tcr" disabled="disabled" readonly="readonly" size="10" title="Account Receivable" 
					value="<?php echo set_value('tcr', isset($default['cr']) ? $default['cr'] : '0'); ?>" onKeyUp="checkdigit(this.value, 'tcr')" /> <br />  </td> 
			</tr>
			
			<tr>
				<td> <label for="tncr"> NCR - Non Tax Account Receivable </label></td> <td>:</td> 
				<td><input type="text" id="tncr" name="tncr" disabled="disabled" readonly="readonly" size="10" title="Non Tax Account Receivable" 
					value="<?php echo set_value('tncr', isset($default['ncr']) ? $default['ncr'] : '0'); ?>" onKeyUp="checkdigit(this.value, 'tncr')" /> <br />  </td> 
			</tr>
			
			<tr>
				<td> <label for="ttr"> TR - Account Transfer </label></td> <td>:</td> 
				<td><input type="text" id="ttr" name="ttr" disabled="disabled" readonly="readonly" size="10" title="Account Transfer" 
			...
			<tr>
				...
				<td><input type="text" id="tsaj" name="tsaj" disabled="disabled" readonly="readonly" size="10" title="Sales Adjustment Journal" 
			...
			<tr>
				...
				<td><input type="text" id="tprj" name="tprj" disabled="disabled" readonly="readonly" size="10" title="Purchase Return Journal" 
