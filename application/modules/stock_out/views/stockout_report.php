        ...
        $(document).ready(function () {
			...
			var rows = $("#table tbody tr");
                ...
                var source = {
                    ...
                    [
						...
						{ name: "Workshop Staff", type: "string" },
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Workshop Staff', dataField: 'Workshop Staff', width : 150 },
			...
			$("#bexport").click(function() {
				...
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'StockOut-Summary'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'StockOut-Summary'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'StockOut-Summary'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'StockOut-Summary'); }
			});
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Stock - Out Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
		   ...
		   <thead>
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Notes </th> <th> Workshop Staff </th> <th> Balance </th> <th> Log </th> 
		   </tr>
           </thead>
