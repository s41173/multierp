...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Stock - Out Report </legend>
				...
				<table>
                    ...
                    <td>  
                     <select name="ctype">
                        ...
                        <option value="3"> Pivot Table </option>
                     </select> &nbsp; <br /> </td>
                    </tr>
                    
                    <tr>
                    <td colspan="2"></td> <td> <input type="submit" name="submit" title="SUBMIT" value=" SUBMIT " />  </td>				
                    </tr>
