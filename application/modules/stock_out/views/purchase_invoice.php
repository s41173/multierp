...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;">  
	...
	<div style="border:0px solid; float:right;">
		...
		<h3 id="pono"> No : PO-00<?php echo $pono; ?> &nbsp; &nbsp; <?php echo 'IDR'; ?> </h3>
...
<!--		 <tr> 
		 ...
		 <tr> <td></td> <td class="left"> Down Payment </td> <td colspan="3"></td>   <td class="right"> <?php echo number_format($p1); ?> </td> </tr>
		 <tr> <td colspan="5"></td>  <td class="right"> <?php echo number_format($p2); ?> </td> </tr>
			
		</table>
		
		<div style="float:left; width:300px; border:0px solid #000;">  
			<p style="margin:0; padding:5px 0 0 0;"> Keterangan : <?php echo $desc; ?> </p>
		</div>
