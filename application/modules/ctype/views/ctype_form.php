...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>" >
				<table>
                    ...
                    <tr> 
						<td> <label for="tvillage"> Contract Type </label> </td> <td>:</td>
						<td> <input type="text" class="required" name="tname" id="tname" size="20" title="Contract Name" 
                             value="<?php echo set_value('tname', isset($default['name']) ? $default['name'] : ''); ?>" /> 
                        </td>        
					</tr>
                    
                    <tr>
                        <td> <label> Account </label> </td> <td> : </td>
