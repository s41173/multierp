...
<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> BUKTI PENGEMBALIAN CREDIT - <?php echo $acc; ?> </h2> 
			...
			if ($items)
			{
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						<td> ".$i." </td>
						<td class=\"left\"> SOV-00".$res->no." - SO-00".$res->sales_no."/ CR-00".$res->ar_payment."&nbsp; </td> 
