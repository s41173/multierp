...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Registration Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
            	...
            	<tr> <td> <label for="cdept">Department</label> </td> <td>:</td>
                     <td> <?php $js = 'id=""'; echo form_dropdown('cdept', $dept, isset($default['dept']) ? $default['dept'] : '', $js); ?> </td>
                </tr>
                
                <tr> <td> <label for="cyear"> Financial Year </label> </td> <td>:</td>
                     <td> <?php $js = 'id=""'; echo form_dropdown('cyear', $year, isset($default['year']) ? $default['year'] : '', $js); ?> </td>
                </tr>
                ...
                <tr>	
                 ...
                 <tr> <td> <label for="ctype"> Report Type </label> </td> <td>:</td>
                     <td> <select name="ctype"> 
                          <option value="0"> Academic - Summary </option> 
                          <option value="1"> Academic - Pivottable </option> 
                          <option value="2"> Finance - Summary </option> 
                          <option value="3"> Finance - Pivottable </option> 
                          <option value="4"> Uniform </option> 
                          </select> 
                     </td>
                </tr>
                
                <tr> <td> <label for="cstts"> Status </label> </td> <td>:</td>
