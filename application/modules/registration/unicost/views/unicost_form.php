...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Add - Uniform Cost </legend>
    <table>
	...
	<form name="modul_form" id="ajaxform" class="myform" method="post" action="<?php echo $form_action; ?>">	
         ...
         <tr>
         <td> <label for="tpair"> Pair </label> </td>  <td>:</td>
         <td> <input type="text" class="required" name="tpair" id="tpair" size="1" title="Paired Uniform" 
              onKeyUp="checkdigit(this.value,'tpair')" 
              value="<?php echo set_value('tpair', isset($default['pair']) ? $default['pair'] : ''); ?>" /> 
         </td>
         </tr>
