...
<div id="webadmin">
    ...
    <form method="get" action="<?php echo $form_action_get; ?>">
    <tr> <td> <label for="tpo"> Type </label> </td> <td>:</td>
    	<td>  <select name="ctype" onchange="this.form.submit();">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" >
					...
					<tr> 
						<td> <label for="tpo"> SO-00 </label> </td> <td>:</td>
						<td> <input type="text" readonly="readonly" class="required" name="tpo" id="titem" size="5" title="SO" /> &nbsp; 
						<?php echo anchor_popup(site_url("csales/get_list/IDR/0/".$st), '[ ... ]', $atts1); ?>
					</tr>
