...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					...
					<td> <label for="tname">NO : SR-00</label> <br />
					     <input type="text" class="" id="tno" name="tno" size="7" title="No"  onkeyup="checkdigit(this.value, 'tno')" /> &nbsp;  
                    </td> 
					
					<td> <label for="tname"> SO-00</label> <br />
					     <input type="text" class="" id="tpo" name="tpo" size="7" title="PO No" onkeyup="checkdigit(this.value, 'tpo')" />  &nbsp; 
                    </td> 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("sales_return/add"), 'CREATE NEW SR', $atts); ?>
		   <?php echo anchor_popup(site_url("sales_return/report"), 'SALES RETURN REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
