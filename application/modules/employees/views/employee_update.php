...
<div id="webadmin">
	...
	<form name="modul_form" id="form" class="myform" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <option value="academic"<?php echo set_select('csection', 'academic', 
			  isset($default['section']) && $default['section'] == 'academic' ? TRUE : FALSE); ?>> 
              Academic 
            </option> 
            <option value="non"<?php echo set_select('csection', 'non', 
			 isset($default['section']) && $default['section'] == 'non' ? TRUE : FALSE); ?>> Non Academic </option> 
                 </select> </td>
        </tr>  
...
<option value="others"<?php echo set_select('creligion', 'others', isset($default['religion']) && $default['religion'] == 'others' ? TRUE : FALSE); ?>> Others </option> 
        ...
        <tr>
            ...
            <td> <input type="text" class="" name="taccname" size="30" title="Account Name"
        ...
        <tr>
            ...
            <td> <input type="text" class="" name="taccno" size="20" title="Account No"
                 value="<?php echo set_value('taccno', isset($default['accno']) ? $default['accno'] : ''); ?>" /> </td>
        </tr>
        
<tr>
<td> <label for="tbank"> Bank </label> </td> <td>:</td>
<td> <textarea name="tbank" cols="35" rows="3"><?php echo set_value('tbank', isset($default['bank']) ? $default['bank'] : ''); ?></textarea> </td>
</tr>
