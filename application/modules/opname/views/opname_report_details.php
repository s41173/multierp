        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Supervisor', dataField: 'Supervisor', width : 150 },
				  { text: 'Log', dataField: 'Log', width : 80, cellsalign: 'center' }
			...
			$("#bexport").click(function() {
				...
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Opname-Report'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Opname-Report'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Opname-Report'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Opname-Report'); }
			});
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Stock Opname - Report Details </h4>
	   </div>
	</center>
	
	<div class="clear"></div>
	
	<div style="width:100%; border:0px solid brown; margin-top:30px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
           ...
           <thead>
           <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Notes </th> <th> Supervisor </th> <th> Log </th> 
		   </tr>
           </thead>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\"> SOP-00".$res->no."</td>
					   <td class=\"strongs\">".$res->desc."</td>
   					   <td class=\"strongs\">".$res->supervisor."</td> 
