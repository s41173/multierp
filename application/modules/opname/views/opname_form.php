	     ...
	     <td> <input type="text" class="required" readonly="readonly" name="tno" id="tno" size="4" title="Name" onkeyup="checkdigit(this.value, 'tno')"
		       value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
					...
					<tr>	
						 ...
						 <td>  
						   <input type="Text" name="tdate" readonly="readonly" id="d1" title="Invoice date" size="10" class="required" 
					...
					<tr>	
	                    ...
	                    <td> <input type="text" class="required" name="tsupervisor" size="15" title="Supervisor" /> &nbsp; <br /> </td>
					</tr>
