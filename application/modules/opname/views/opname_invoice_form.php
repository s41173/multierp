...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Stock - Opname Receipt </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
				<table>
					<tr>
						...
						<td> <input type="text" class="required" readonly="readonly" name="tproduct" id="tproduct" size="30" title="Name" /> &nbsp;
