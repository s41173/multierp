...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Transcode </td> <td>:</td> <td> <?php echo $codetrans; ?>-<?php echo $code; ?> </td> </tr>
	...
	<div style="margin:3px 0 0 0; border-bottom:0px dotted #000;">
		...
		<tr> <td></td> <td colspan="1"></td> <td class="right"> <b> Total : </b> </td>
             <td class="right"> <b> <?php echo number_format($debit); ?> </b> </td>
             <td class="right"> <b> <?php echo number_format($credit); ?> </b> </td> 
        </tr>
