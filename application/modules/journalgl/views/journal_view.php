...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Journal GL </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
                    
                    <td> <label for="cref"> Ref : </label> <br />                   
       <?php $js = 'id="cref"'; echo form_dropdown('cref', $jurnaltype, isset($default['journaltype']) ? $default['journaltype'] : '', $js); ?> &nbsp;
					</td> 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("journalgl/add"), 'CREATE NEW', $atts); ?>
		   <?php echo anchor_popup(site_url("journalgl/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
