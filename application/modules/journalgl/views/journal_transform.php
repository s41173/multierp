...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
	     ...
	     <td> <input type="text" class="required" readonly name="tno" size="4" title="Name" value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
                    ...
                    <tr>	
<td> <label for="tcode"> Code </label> </td> <td>:</td>
<td> <input type="text" class="required" readonly name="tcode" size="4" title="Name" value="<?php echo isset($codetrans) ? $codetrans : ''; ?>" /> &nbsp; <br /> </td>
					</tr>
...
<td> <textarea name="tdesc" class="required" title="Description" cols="40" rows="3"><?php echo set_value('tdesc', isset($default['desc']) ? $default['desc'] : ''); ?></textarea> &nbsp; <br /> </td></tr>	
    ...
    <div class="clear"></div>
    <div style="width:250px; height:85px; float:right; margin:5px;">
    	<table>
        	<tr> 
                <td> <label> Debit : </label> <br> <input type="text" size="15" readonly value="<?php echo $debit; ?>"> </td> 
                <td> <label> Credit : </label> <br> <input type="text" size="15" readonly value="<?php echo $credit; ?>"> </td> 
            </tr>
            
            <tr> 
                <td> <label> Balance : </label> &nbsp; <input type="text" size="15" readonly value="<?php echo $balance; ?>"> </td> 
            </tr>
        </table>
    </div>	
