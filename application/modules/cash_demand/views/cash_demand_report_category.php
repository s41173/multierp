...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	      <h4> <?php echo isset($company) ? $company : ''; ?> <br> Cheque Request - Report Category </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:0px dotted #000000; ">
		...
		<table id="table" border="0">
		 <thead>
         <tr>
 	     <th>No</th> <th>Date</th> <th>Order No</th> <th>Vendor</th> <th> Code </th> <th>Category</th> <th>Notes</th> 
         <th>Approval</th> <th> Balance </th>
		 </tr>
         </thead>
		  ...
		  <?php 	
			  ...
			  {
				  $res = new Vendor_lib();
				  return $res->get_vendor_name($val);
			  }
			  ...
			  if ($aps)
			  {
				...
				{	
				   ...
				   <td class=\"strongs\" align=\"center\">RC-00".$ap->no."</td>
				   <td class=\"strongs\" align=\"center\">".strtoupper(vendor($ap->vendor))."</td> 
				   <td class=\"strongs\" align=\"left\">".$ap->code."</td>
