...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Cash Demand - Transaction </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" >
				<table>
                	...
                	<tr>	
						 <td> <label for="torderno"> RC-00 </label> </td> <td>:</td>
						 <td> <input type="text" class="required" readonly="readonly" name="tno" size="5" title="Order No"
					...
					<tr>
						...
						<td> <input type="text" class="" name="tdocno" size="10" title="Document No" /> &nbsp; <br /> </td>
					</tr>
