...
<script type="text/javascript">	
	...
	function setbr()
	{
		var nilai = document.getElementById("tnotes").value;
		document.getElementById("tnotes").value = nilai + " <br /> ";
	}
</script>
...
<div id="webadmin">
	...
	<fieldset class="field" style="float:left;"> <legend> Cash Demand Transaction </legend>
	...
	<form name="modul_form" class="myform" id="ajaxform2" method="post" action="<?php echo $form_action_item; ?>">
		<table>
			<tr>
				...
				<td> <br />
					<input type="submit" name="submit" title="POST" value="POST" /> 
				</td>
			</tr>
		</table>
