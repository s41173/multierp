...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Cash Request - Transaction </legend>
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor(site_url("cash_demand/add"), 'CREATE NEW', $atts); ?>
		   <?php echo anchor(site_url("cash_demand/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
