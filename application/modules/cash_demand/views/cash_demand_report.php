...
<style media="all">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
			...
			$('#jqxgrid').jqxGrid({ pagesizeoptions: ['10', '20', '30', '40', '50', '100', '200', '500', '2000']}); 
			...
			{
				var site = "<?php echo site_url('cash_demand/invoice/');?>";
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Cheque Request - Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:0px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
           <thead>
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Vendor </th> <th> Type </th> <th> Order No </th> <th> Notes </th> <th> Approval </th> <th> Balance </th>
		   </tr>
           </thead>
		  ...
		  <?php 
			  ...
			  {
				   $ven = new Vendor_lib();
				   if ($val == 0){ return '-'; } else { return $ven->get_vendor_name($val); }
			  }
			  ...
			  if ($aps)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\">".vendor($ap->vendor)."</td>
					   <td class=\"strongs\">".strtoupper($ap->type)."</td> 
					   <td class=\"strongs\"> RC-00".$ap->no."</td> 
