...
<div id="webadmin">
	...
	<fieldset class="field" style="float:left;"> <legend> Sales Adjustment </legend>
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
				<table>
					
					<tr>	
						<td> <label for="tno"> No - SAJ-00 </label> </td> <td>:</td>
	     <td> <input type="text" class="required" readonly="readonly" name="tno" size="4" title="Name" value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
					...
					<tr>
						<td> <label for="titem"> (Sales) SO-00 : </label> </td> <td>:</td>
						<td> <input type="text" class="required" readonly="readonly" name="tsales" id="titem" size="5" title="Transaction Code"
							 ...
							 <?php echo anchor_popup(site_url("sales/get_list/".$default['currency']), '[ ... ]', $atts1); ?> &nbsp; </td>
					</tr>
					...
					<tr>
					    ...
					    <td> <input type="text" readonly="readonly" name="ttotal" id="ttotal" size="15" title="Total"
						     ...
						     <input type="button" name="bgetsalesno" id="bgetsalesno" value="GET AMOUNT" /> </td>	 
					</tr>	
					
					<tr>
						<td> <label for="tdp"> DP </label> </td>  <td>:</td>
					    <td> <input type="text" readonly="readonly" name="tdp" id="tdp" size="15" title="DP"
						     value="<?php echo set_value('tdp', isset($default['dp']) ? $default['dp'] : ''); ?>" /> &nbsp; <br /> </td>
					</tr>	
					...
					<tr>
						...
						<td> <input type="text" class="required" name="tdocno" size="15" title="Document No"
		...
		<td> <textarea name="tdesc" class="required" title="Description" cols="45" rows="3"><?php echo isset($desc) ? $desc : ''; ?></textarea> &nbsp; <br /> </td></tr>	
