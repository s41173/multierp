	    ...
	    <form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
           ...
           <tr>
                ...
                &nbsp;
           		...
           		<td> <label for="tdesc"> Code </label> </td>  <td>:</td>
                <td> <input type="text" class="readonly" name="tcode" size="5" 
                value="<?php echo set_value('tcode', isset($default['code']) ? $default['code'] : ''); ?>" />
                </td>
           
                <td> <label for="tdesc"> Desc </label> </td>  <td>:</td>
                <td> <input type="text" name="tdesc" size="20" 
                value="<?php echo set_value('tdesc', isset($default['desc']) ? $default['desc'] : ''); ?>" />
                </td>
            </tr> 
