	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
	     ...
	     <td> <input type="text" class="required" readonly name="tno" size="4" title="Name" value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
                    ...
                    <tr>	
	                    ...
	                    <td> <select name="ctype" id="sctype">
                        	 <option value=""> -- </option> 
                             ...
                             value="<?php echo set_value('tvoucherno', isset($default['voucherno']) ? $default['voucherno'] : ''); ?>" />
                        </td>
					</tr>
...
<td> <textarea name="tdesc" class="required" title="Description" cols="40" rows="3"><?php echo set_value('tdesc', isset($default['desc']) ? $default['desc'] : ''); ?></textarea> &nbsp; <br /> </td></tr>	
    ...
    <fieldset class="field" style="float:left; margin-left:15px;"> <legend> Check Details </legend>
		...
		<table>
          ...
          <tr>
            <td> Post Dated </td>  <td>:</td>
            <td> <?php echo form_checkbox('cpost', 1, set_value('cpost', isset($default['post']) ? $default['post'] : 'FALSE')); ?> </td>
          </tr>
	...
	<option value="giro" <?php echo set_select('ccheck_type', 'giro', isset($default['check_type']) && $default['check_type'] == 'giro' ? TRUE : FALSE); ?> /> Giro </option>
				...
				value="<?php echo set_value('tcheck', isset($default['check']) ? $default['check'] : ''); ?>" /> &nbsp; <br /> 
                </td>
			</tr>
		...
		<table>
			<tr>
                ...
                <td>  
					...
					<input type="text" class="required" name="tnotes" id="tnote" size="35" title="Staff" />
