...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="sajaxform" method="post" action="<?php echo $form_action_item; ?>">
				<table>
                    ...
                    <tr>
                    <td> <label for="tdates"> Trans Dates </label> </td> <td>:</td>
                    <td> <input type="Text" name="tdates" id="d2" title="Trans date" size="10" class="required"
                    ...
                    <td> <input type="text" class="" name="tdocno" size="20" title="Doc-No" value="<?php echo set_value('tdocno', isset($default['docno']) ? $default['docno'] : ''); ?>" />  </td> 
                    </tr>
