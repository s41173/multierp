...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> RECEIPT OF PAYMENT </h2> 
    <div style="clear:both; "></div> 
	
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Paid To </td> <td>:</td> <td> <?php echo $staff; ?> </td> </tr>
	...
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> Transcode </td> <td>:</td> <td> <?php echo 'GJ-00'.$pono; ?> </td> </tr>
            <tr> <td> Date </td> <td>:</td> <td> <?php echo date('d-m-Y'); ?> </td> </tr>
		</table>
	</div>
		 ...
		 <?php
			...
			echo "
			 ...
			 <tr> 
				...
				<td class=\"left\"> ".$acc->get_code($cost_lib->get_acc($cost))." </td> 
