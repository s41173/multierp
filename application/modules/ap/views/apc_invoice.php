...
<title> AP-Payment - DJ-00<?php echo isset($pono) ? $pono : ''; ?></title>
<style media="all">
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> BANK OUT TRANSACTION </h2> 
    <div style="clear:both; "></div> 
	
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Transcode </td> <td>:</td> <td> <p style="font-size:14px; font-weight:bold;"> DJ-00<?php echo $pono; ?> </p> </td> </tr>
            <tr> <td> Demand </td> <td>:</td> <td> <p style="font-size:12px; font-weight:bold;"> RC-00<?php echo $demand; ?> </p> </td> </tr>
            <tr> <td> Paid To </td> <td>:</td> <td style="font-weight:bold; font-size:14px;"> <?php echo $vendor; ?> </td> </tr>
            <tr> <td> </td> <td></td> <td> <?php echo $venbank; ?> </td> </tr>
			<tr> <td> Currency </td> <td>:</td> <td> <?php echo $currency; ?> </td> </tr>
            <tr> <td> Payment </td> <td>:</td> <td> <?php echo $check.' / '.$bank.' / '.tglin($due); ?> </td> </tr>
		</table>
	</div>
	...
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
            ...
            <tr> <td> Type </td> <td>:</td> <td> <?php echo $type; ?> / <?php echo $voucherno; ?> </td> </tr>
	...
	<div style="margin:5px 0 0 0; border-bottom:0px dotted #000;">
