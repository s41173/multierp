...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Cash - OUT </legend>
	     ...
	     <td> <input type="text" class="required" name="tno" id="tno" size="4" title="Name" onkeyup="checkdigit(this.value, 'tno')"
			...
			<br />  </td> </tr>
					...
					<tr>
						...
						<td>  <input type="text" class="required" name="tnote" size="52" title="Note" /> &nbsp; <br /> </td>
					</tr>
					
					<tr> <td> <label for="tdesc"> Description </label> </td> <td>:</td> 
				    <td> <textarea name="tdesc" class="required" title="Description" cols="39" rows="3"></textarea> &nbsp; <br /> </td></tr>	
