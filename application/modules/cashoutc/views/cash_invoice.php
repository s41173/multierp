...
<title> AP-Payment - CD-0000<?php echo isset($pono) ? $pono : ''; ?></title>
<style media="all">
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> CASH OUT </h2> <div style="clear:both; "></div> 
	...
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
            <tr> <td> No </td> <td>:</td> <td> <?php echo 'CD-0000'.$pono; ?> </td> </tr>
	...
	<div style="margin:3px 0 0 0; border-bottom:0px dotted #000;">
		...
		<style>
			...
			<table border="0" class="sig">
				<tr> <td> Approved By : </td> <td> Reviewed By : </td> <td> Received By : </td> <td> Paid By : </td> </tr>
			</table> <br> <br> <br> <br> <br> <br>
			
			<table border="0" class="sig">
				<tr> <td> Manager </td> <td> Accounting </td> <td> <?php echo $vendor; ?> </td> <td> ___________________ </td> </tr>
			</table>
		</div>
