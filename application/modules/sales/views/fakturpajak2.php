...
<table border="0" style="font-size:8px; float:right; width:265px;">
	<tr> <td style="width:70px;"> Lembar Ke-2 : </td> <td colspan="2" style="line-height:0px; padding:0;"> Untuk Pengusaha Kena Pajak yang </td> </tr>
	<tr> <td style="width:70px;"> </td> <td style="line-height:10px; padding:0;"> menerbitkan Faktur Pajak sebagai <br> Bukti Pajak Keluaran </td> </tr>
</table>
<div class="clear"></div>
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px; border:1px solid #000;">
	...
	<div class="row"> <p> Kode dan No Seri Faktur Pajak : &nbsp; &nbsp; &nbsp; <?php echo $tax_serial; ?> </p> </div>
	...
	<div class="contentboxright" style="width:273px;"> <p style="padding:7px 15px 0 0; text-align:right;"> <?php echo number_format($total,0,",","."); ?> ,- </p> </div>
...
<!-- free box -->
	...
	<?php echo number_format($total,0,",","."); ?> ,- </p> </div>
	...
	<div class="contentboxright" style="width:273px; border-top:1px solid #000;"> <p style="padding:5px 15px 0 0; text-align:right;"> 
	<?php echo number_format($total-$discount,0,",","."); ?> ,- </p> </div>
	...
	<div class="bigrow1"> 
		...
		<p style="padding:20px 0px 0 145px; font-size:12px; font-weight:bold; float:left;"> Medan, tanggal : &nbsp; <?php echo $podate; ?> </p> <br>
