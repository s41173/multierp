...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> Registration Cost Report </p>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border:1px solid #000; ">
		...
		<table border="0" width="100%">
		   <tr>
  	       <th> No </th> <th> Department </th> <th> Level </th> <th> Registration </th> <th> Development </th> <th> School </th> <th> OSIS </th> 
           <th> Computer </th> <th> Practice </th> <th> Others </th> <th> P1 </th>
		   </tr>
			  ...
			  if ($results)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\" align=\"center\">".$res->level."</td>
					   ...
					   <td class=\"strongs\" align=\"right\">".number_format($res->other)."</td>
