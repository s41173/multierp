...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Recapitulation Of Practice Fees </h4>
	   </div>
	</center>
...
.anchor_popup(site_url("tuition_transaction/get_list/".$res->dept_id."/".$res->grade_id."/".$monthperiod."/".$year.'/null/null/praktek'), '[ Details ]', $atts).
					   " </div> </td>
