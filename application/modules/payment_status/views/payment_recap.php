...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Recapitulation Of School Fees </h4>
	   </div>
	</center>
		...
		<table border="0" width="100%">
           ...
           <?php
				...
				function realisasi($dept,$grade,$month,$financialyear,$type=null,$scholar=null)
				{
					...
					return intval($res['school_fee']-$res['aid_foundation']);
				}
...
//    $jml_siswa = intval($prevsiswa+$insiswa-$inactive-$outsiswa);
   ...
   .anchor_popup(site_url("tuition_transaction/get_list/".$res->dept_id."/".$res->grade_id."/".$monthperiod."/".$year), '[ Details ]', $atts).
					   "</td> 
				   </tr>
					   ";    
				   $i++;
