...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Payroll Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
            ...
            <tr>	
            <td> <label for="tstart"> Period Year </label> </td> <td>:</td>
            <td> <input type="text" class="required" name="tyear" id="tyear" size="4"> </td> 						
            </tr>	   
			</table>
