...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Payable Report Panel </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
			...
			<tr> 
                ...
                <td> <input type="text" class="required" name="tvendor" id="tcust" size="35" title="Name" required /> &nbsp; 
            ...
            <tr>	
                 ...
                 <td>  
                   <input type="Text" name="tstart" id="d1" title="Start date" size="10" required /> 
                   <img src="<?php echo base_url();?>/jdtp-images/cal.gif" onclick="javascript:NewCssCal('d1','yyyymmdd')" style="cursor:pointer"/> &nbsp; - &nbsp;
                   
                   <input type="Text" name="tend" id="d2" title="End date" size="10" required /> 
                   <img src="<?php echo base_url();?>/jdtp-images/cal.gif" onclick="javascript:NewCssCal('d2','yyyymmdd')" style="cursor:pointer"/> &nbsp; <br />
                </td> 						
            </tr>
            
<!--            <tr>	
                 <td> <label for="tstart"> Due Date </label> </td> <td>:</td>
                 <td>  
                   <input type="Text" name="tduestart" id="d3" title="Start date" size="10" class="required" /> 
                   <img src="<?php echo base_url();?>/jdtp-images/cal.gif" onclick="javascript:NewCssCal('d3','yyyymmdd')" style="cursor:pointer"/> &nbsp; - &nbsp;
                   
                   <input type="Text" name="tdueend" id="d4" title="End date" size="10" class="required" /> 
                   <img src="<?php echo base_url();?>/jdtp-images/cal.gif" onclick="javascript:NewCssCal('d4','yyyymmdd')" style="cursor:pointer"/> &nbsp; <br />
                </td> 						
            </tr>-->
             
            <tr>	
			<td> <label for="ctype"> Trans Type </label> </td> <td>:</td>
			<td>  
			 <select name="ctrans">
                <option value=""> -- </option>
			 	<option value="PO"> Purchase Order </option>
                <option value="CP"> Vinyl Order </option>
			 </select> &nbsp; <br /> </td>
			</tr>        
			...
			<td>  
			 <select name="ctype">
                ...
                <!--<option value="1"> Pivot Table </option>-->
			 </select> &nbsp; <br /> </td>
			</tr>
				...
				<p style="margin:15px 0 0 0; float:left;">
                    ...
                    <input type="reset" name="reset" class="button" title="RESET" value="RESET" /> 
				</p>	
			</form>			  
	</fieldset>
</div>
