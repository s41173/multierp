...
//        $this->sales = $this->load->library('sales');
    ...
    function index()
    {
//        $this->get_last_closing();
        
//        if ($this->cek_component() == 0){ $this->session->set_flashdata('message', "Closing Rollback - Transaction Has Not Been Approved...!"); redirect('main'); }
//        else{ $this->closing_process(); }  
