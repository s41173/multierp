...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					...
					<td> <label for="tname">NO : NSO-00</label> <br /> <input type="text" class="" id="tno" name="tno" size="9" title="No" 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("nsales/add"), 'CREATE NEW SO', $atts); ?>
		   <?php echo anchor(site_url("ar_payment"), 'AR - PAYMENT', $atts); ?>
		   <?php echo anchor_popup(site_url("nsales/report"), 'SALES REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
