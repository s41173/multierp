...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Sales Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
				<table>
					<tr> 
						...
						<td> <input type="text" class="required" name="tcust" id="tcust" size="35" title="Name" /> &nbsp; 
			...
			<td>  
			 <select name="ctype">
			 	<option value="sum" selected="selected"> Summary </option>
