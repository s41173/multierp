...
<style media="all">
	...
	p.notes { color:#F00; font-weight:bold; font-style:italic; }
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> CASH IN TRANSACTION - <?php echo $acc; ?> </h2> <div style="clear:both; "></div> 
	
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Diterima Dari </td> <td>:</td> <td> <?php echo $customer; ?> </td> </tr>
			<tr> <td> </td> <td> </td> <td> <?php echo $ven_bank; ?> </td> </tr>
            <tr> <td> </td> <td> </td> <td> <?php echo $check.' - '.tglin($checkdue); ?> </td> </tr>
		</table>
	</div>
	
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> </td> <td>:</td> <td> <p style="font-size:14px; font-weight:bold;"> CR-00<?php echo $pono; ?> </p> </td> </tr>
	...
	<div style="margin:3px 0 0 0; border-bottom:0px dotted #000;">
		...
		<table class="product">
		 ...
		 <tr> <th> No </th>  <th> Desc </th> <th> Amount </th> <th> Tax (VAT) </th> <th> Desc </th> <th> Balance </th> </tr>
			...
			if ($items)
			{
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						<td> ".$i." </td>
						<td class=\"left\"> ".$res->code."-00".$res->no." - ".$res->notes." &nbsp; - &nbsp; ".tgleng($res->dates)." <br> <p class=\"notes\">". $res->transnotes ."</p> </td> 
						<td class=\"right\"> ".number_format($res->amount+$res->cost+$res->tax2)." </td>
						<td class=\"right\"> ".number_format($res->tax)." </td>
						<td class=\"center\"> <br> Cost : <br> Deduction : </td> 
						<td class=\"right\"> ".number_format($res->amount+$res->tax+$res->cost+$res->tax2)." <br> (".number_format($res->cost).") <br> (".number_format($res->tax2).") </td>  
					 </tr>
		 ...
		 <tr> <td></td> <td class="right"> <b> Total : </b> </td> <td class="right"> <b> <?php echo $amount; ?> </b> </td> </tr>
		...
		<style>
			...
			<table border="0" class="sig">
				<tr> <td> Direktur </td> <td> Accounting </td> <td> ___________________ </td> <td> ___________________ </td> </tr>
			</table>
		</div>
