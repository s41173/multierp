...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> AR - Customer Payment </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
                    ...
                    <tr>
						<td> <label for="tdocno"> Order No </label> </td>  <td>:</td>
						<td>  <input type="text" class="required" name="tno" id="tno" size="5" value="<?php echo $code; ?>" title="Order No" onKeyUp="checkdigit(this.value, 'tno')" /> &nbsp; <br /> </td>
					</tr>
