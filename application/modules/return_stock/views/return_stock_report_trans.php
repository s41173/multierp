        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Purchase', dataField: 'Purchase', width : 150 },
				  ...
				  { text: 'Unit', datafield: 'Unit', width: 130 }
                ]
            });
			...
			$("#bexport").click(function() {
				...
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Stock-IN-Trans'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Stock-IN-Trans'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Stock-IN-Trans'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Stock-IN-Trans'); }
			});
			...
			{
				var site = "<?php echo site_url('stock_in/print_invoice/');?>";
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Stock - In Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
		   <thead>
           <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Purchase </th> <th> Product </th> <th> Qty </th> <th> Unit </th> 
		   </tr>
           </thead>
		  ...
		  <?php 
			  ...
			  if ($reports_trans)
			  {
				...
				function vendor($po)
				{
					$purchase = new Purchase_lib();
					$vendor = new Vendor_lib();
					$purchase = $purchase->get_po($po);
					return $vendor->get_vendor_name($purchase->vendor);
				} 
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\">".get_name($res->product)."</td> 
   					   <td class=\"strongs\">".$res->qty."</td>
					   <td class=\"strongs\">".get_unit($res->product)."</td> 
				   </tr>";
				   $i++;
				}
			 }  
