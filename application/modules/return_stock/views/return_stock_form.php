	     ...
	     <td> <input type="text" class="required" readonly="readonly" name="tno" id="tno" size="4" title="Name" onkeyup="checkdigit(this.value, 'tno')"
		       value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
					...
					<tr>	
	                    ...
	                    <td> <input type="text" class="required" readonly="readonly" name="tbpbg" id="tbpbg" size="10" title="Stock Out" /> &nbsp;
				             <?php echo anchor_popup(site_url("stock_out/get_list/"), '[ ... ]', $atts1); ?> &nbsp; &nbsp; 
						</td>
					</tr>
