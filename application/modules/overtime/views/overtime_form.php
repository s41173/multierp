...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Add - Division Overtime </legend>
    <table>
  ...
  <td> 
  <?php $js = 'class="required"'; echo form_dropdown('cdivision', $division, isset($default['division']) ? $default['division'] : '', $js); ?>
  </td>
  </tr>
