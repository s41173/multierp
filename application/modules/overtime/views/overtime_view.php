...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Employee Overtime </legend>	
    ...
    <td> 
    <label for="tname"> Division : </label> 
	<?php $js = 'class=""'; echo form_dropdown('cdivision', $division, isset($default['division']) ? $default['division'] : '', $js); ?>
    </td>
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("overtime/add"), 'ADD NEW', $atts2); ?>
           <?php echo anchor_popup(site_url("overtime/report"), 'REPORT', $atts1); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
