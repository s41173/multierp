...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Update - Foundation </legend>
    <table>
	...
	<form name="modul_form" id="ajaxform" class="myform" method="post" action="<?php echo $form_action; ?>">	
         ...
         <td> <input type="text" class="required" name="tname" id="tname" size="35" title="Name" 
         ...
         <td> <input type="text" name="trole" readonly size="15"
              value="<?php echo set_value('trole', isset($default['role']) ? $default['role'] : ''); ?>"> 
         </td>
         </tr>
