...
<title> Stock Demand - FPB-00<?php echo isset($no) ? $no : ''; ?></title>
...
<style type="text/css" media="all">
	...
	table.tab1 td.name { text-align:left; width:6cm; padding:3px 0 4px 5px; }
	table.tab1 td.qty { text-align:center; width:2cm; padding:3px; }
	table.tab1 td.unit { text-align:center; width:1.3cm; padding:3px; }
	table.tab1 td.desc { text-align:left; width:4.2cm; padding:3px; }
	table.tab1 td.ddate { text-align:left; width:1.5cm; padding:3px; }
	table.tab1 td.vendor { text-align:left; width:2cm; padding:3px; }
...
<div id="container">
	...
	<div id="venbox">
		<table width="100%" style="font-size:1em; margin:0; text-align:left;">
		    <tr> <td> No.FPB </td> <td>:</td> <td> <p style="padding:0; margin:0; font-weight:bold; font-size:1.5em; "> <?php echo '0'.$no; ?> </p> </td> </tr>
	...
	<div id="titbox"> 
		<p style="padding:0; margin:0 0 0 5cm; font-weight:bold; font-size:1.3em; text-align:left;"> FORMULIR PERMINTAAN BARANG </p>
	</div>
...
<tr> 
<th class="no"> No </th> <th class="name"> Nama Barang </th> <th class="unit"> Satuan </th> <th class="desc"> Keperluan </th>  <th class="ddate"> Tgl <br /> Butuh </th> 
<th class="vendor"> Supplier </th> <th class="vendor"> No. Telp <br /> Supplier </th>
</tr>		
			...
			foreach ($items as $res)
			{
				echo "
				 ...
				 <tr> 
					...
					<td class=\"desc\">".tglin($res->demand_date)."</td>
					<td class=\"desc\">".$res->prefix.' '.$res->name."</td>
					<td class=\"desc\">".$res->phone1."</td>
				 </tr>
...
?>
	...
	<div id="signbox"> 
		...
		<div style="height:2.15cm; width:3cm; border:0pt solid blue; float:left; padding:0;"> 
			...
			<p style="padding:0.7cm 0 0 0; text-align:center;"> ( &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ) <br /> Workshop User </p> 
		</div>
		...
		<div style="height:2.15cm; width:3cm; border:0pt solid blue; float:left; padding:0; margin:0 0 0 1.7cm;"> 
			...
			<p style="padding:0.7cm 0 0 0; text-align:center;"> ( <?php echo $supervisor; ?>  ) <br /> Supervisor </p> 
		</div>
