...
<div id="webadmin">
	...
	<fieldset class="field" style="float:left;">  <legend> Stock Demand </legend>
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
	     ...
	     <td> <input type="text" class="required" readonly="readonly" name="tno" size="4" title="No" value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
					</tr>
					...
					<tr>	
						<td> <label for="tsupervisor"> Supervisor </label> </td> <td>:</td>
 	                    <td> <input type="text" class="required" name="tsupervisor" size="15" title="Supervisor"
						     value="<?php echo set_value('tsupervisor', isset($default['supervisor']) ? $default['supervisor'] : ''); ?>" /> &nbsp; <br /> </td>
					</tr>		
		...
		<table>
			<tr>				
				...
				<td>  
					...
					<input type="text" name="tdesc" size="20" title="Desc" /> &nbsp;
				</td>
				
				 <td> <label for="tdate"> Demand Date </label> <br> 
				   <input type="Text" name="tdemanddate" id="d2" title="Demand date" size="10" class="required"
				...
				<td> <label for="tvendor"> Vendor </label> <br>
				     <input type="text" class="required" readonly="readonly" name="tvendor" id="tcust" size="25" title="Name" /> &nbsp; 
					<?php echo anchor_popup(site_url("vendor/get_list/"), '[ ... ]', $atts1); ?> 
				</td>
								
				<td> 
					<br> <input type="submit" name="submit" class="button" title="POST" value="POST" /> 
				</td>
			</tr>
		</table>
