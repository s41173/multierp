...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Stock Demand - Report Details </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Notes </th> <th> Log </th> 
		   </tr>
		  ...
		  <?php 
			  ...
			  {
				 $CI =& get_instance();
				 $poder = $CI->Demand_item_model->report($po)->result();
				 $i=1;
				...
				foreach ($poder as $res)
				{
				   ...
				   <td class=\"poder\">".$res->desc.' - '.tglin($res->demand_date).' - '.$res->prefix.' '.$res->name."</td>
				   </tr>";
				   $i++;
				} 
