...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					...
					<td> <label for="tname">NO : CO-00</label> <br /> <input type="text" class="" id="tno" name="tno" size="9" title="No" 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("commission/add"), 'CREATE NEW COMMISSION', $atts); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
