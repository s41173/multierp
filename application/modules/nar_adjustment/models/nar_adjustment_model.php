...
class Nar_adjustment_model extends CI_Model
{
    ...
    function get_last_nar_adjustment($limit, $offset)
    {
        $this->db->select('id, no, dates, nsales_no, currency, user, notes, total, approved, log');
    ...
    function get_nar_adjustment_by_id($uid)
    {
        $this->db->select('id, no, dates, nsales_no, currency, user, notes, total, approved, log');
        $this->db->from($this->table);
        $this->db->where('id', $uid);
    ...
    function get_nar_adjustment_by_no($uid)
    {
        $this->db->select('id, no, dates, nsales_no, currency, user, notes, total, approved, log');
        $this->db->from($this->table);
