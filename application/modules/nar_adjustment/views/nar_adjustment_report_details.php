...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Non Tax AR - Adjustment Report Details </h4>
	   </div>
	</center>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\"> NARJ-00".$res->no."</td>
					   <td class=\"strongs\"> NSO-00".$res->nsales_no."</td>
