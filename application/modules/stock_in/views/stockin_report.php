        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Purchase', dataField: 'Purchase', width : 200 },
  				  { text: 'Vendor', datafield: 'Vendor', cellsalign: 'left' },
				  { text: 'Courier', datafield: 'Courier', width: 150 },
			...
			$("#bexport").click(function() {
				...
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Stock-IN-Summary'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Stock-IN-Summary'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Stock-IN-Summary'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Stock-IN-Summary'); }
			});
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
		   <thead>
           <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Purchase </th> <th> Vendor </th> <th> Courier </th> <th> Log </th> 
		   </tr>
           </thead>
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\"> PO-00".$res->purchase."</td> 
   					   <td class=\"strongs\">".vendor($res->purchase)."</td>
