...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> STOCK - IN </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>

					<tr>	
						<td> <label for="tno"> BTB-00 </label> </td> <td>:</td>
	                    <td> <input type="text" class="required" name="tno" id="tno" size="5" title="Name" onKeyUp="checkdigit(this.value, 'tno')"
					...
					<tr>
						...
						<td> <input type="text" class="required" readonly name="tpo" id="titem" size="5" title="Transaction Code" />
							<?php echo anchor_popup(site_url("purchase/get_list/"), '[ ... ]', $atts1); ?> &nbsp; <br />
						</td>
					</tr>
							
					<tr>	
						<td> <label for="tstaff"> Vendor / Staff </label> </td> <td>:</td>
	                    <td> <input type="text" class="required" name="tstaff" size="20" title="Staff"  /> &nbsp; <br /> </td>
					</tr>
