...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Tuition Over Payment </legend>
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("tuition_over"), 'TUITION OVER PAYMENT TYPE', $atts); ?>
		   <?php echo anchor_popup(site_url("tuition_over_trans/add"), 'CREATE NEW', $atts1); ?>
		   <?php echo anchor_popup(site_url("tuition_over_trans/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
