...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Update - Experience Premium </legend>
    <table>
	...
	<form name="modul_form" id="ajaxform" class="myform" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data">
		 ...
		 <tr>
         <td> <label for="ttime"> Time Work </label> </td>  <td>:</td>
         <td> <input type="text" class="required" name="ttime" size="3" maxlength="2" title="Time Work"
