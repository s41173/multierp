...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> AP - Report <br /> Repository </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Vendor </th> <th> Notes </th> <th> Cur </th> <th> Acc </th> <th> Balance </th> <th> Status </th> <th> Log </th> 
		   </tr>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\" align=\"center\">".status($res->status)."</td> 
