...
<div id="webadmin">
    ...
    <fieldset class="field"> <legend> Fee Type </legend>	
        ...
        <?php $js = 'class=""'; echo form_dropdown('cgrade', $level, isset($default['grade']) ? $default['grade'] : '', $js); ?>
        </td> 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
           <?php echo anchor_popup(site_url("school_fee/add"), 'ADD NEW', $atts1); ?>
           <?php echo anchor_popup(site_url("school_fee/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
