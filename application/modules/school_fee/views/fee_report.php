...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> School Fee Report </p>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border:1px solid #000; ">
		...
		<table border="0" width="100%">
		   <tr>
  	       <th> No </th> <th> Department </th> <th> Grade </th> <th> Registration </th> <th> Development </th> <th> School </th> <th> OSIS </th>
           <th> Computer </th> <th> Practical </th> <th> Others </th> <th> P1 </th>
		   </tr>
			  ...
			  if ($results)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\" align=\"left\">".dept($res->dept_id)."</td>
					   <td class=\"strongs\" align=\"center\">".grade($res->grade)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->registration)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->development)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->school)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->osis)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->computer)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->practice)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->others)."</td>
					   <td class=\"strongs\" align=\"right\">".number_format($res->p1)."</td>
				   </tr>";
				   $i++;
				}
			  }  
