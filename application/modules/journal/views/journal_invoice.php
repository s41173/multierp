...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
        ...
        <fieldset> <legend> CSJ - Cash Sales Journal </legend>
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Code </th> <th> Notes </th> <th> Balance </th> 
		   </tr>
		...
		<tr> <td></td> <td></td> <td align="right"> Total : </td> <td class="strongs" align="right"> <?php echo number_format($total_CSJ) ?> </td> </tr>
        ...
        <fieldset> <legend> CDS - Cash Sales Down Payment </legend>
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Code </th> <th> Notes </th> <th> Balance </th> 
		   </tr>
		...
		<tr> <td></td> <td></td> <td align="right"> Total : </td> <td class="strongs" align="right"> <?php echo number_format($total_CDS) ?> </td> </tr>
        ...
        <fieldset> <legend> CCR - Cash Receivable </legend>
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Code </th> <th> Notes </th> <th> Balance </th> 
		   </tr>
   	    ...
   	    <tr> <td></td> <td></td> <td align="right"> Total : </td> <td class="strongs" align="right"> <?php echo number_format($total_CCR) ?> </td> </tr>
		...
		<fieldset> <legend> ARJ - AR - Payment Journal </legend>
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Code </th> <th> Notes </th> <th> Balance </th> 
		   </tr>
		   ...
		   <tr> <td></td> <td></td> <td align="right"> Total : </td> <td class="strongs" align="right"> <?php echo number_format($total_ARJ) ?> </td> </tr>
		</table>
		</fieldset>
		
		
		<fieldset> <legend> RF - Customer Credit Refund Journal </legend>
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Code </th> <th> Notes </th> <th> Balance </th> 
		   </tr>
		   ...
		   <tr> <td></td> <td></td> <td align="right"> Total : </td> <td class="strongs" align="right"> <?php echo number_format($total_RF) ?> </td> </tr>
		</table>
		</fieldset>
		
		<fieldset> <legend> AJ - Assembly Journal </legend>
		<table border="0" width="100%">
		   <tr>
 	       <th> No </th> <th> Code </th> <th> Notes </th> <th> Balance </th> 
		   </tr>
		   ...
		   <tr> <td></td> <td></td> <td align="right"> Total : </td> <td class="strongs" align="right"> <?php echo number_format($total_AJ) ?> </td> </tr>
		</table>
		</fieldset>
