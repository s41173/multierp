...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Cost Type </legend>	
        ...
        <form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
			...
			<?php $js = 'class="required"'; echo form_dropdown('ccategory', $category, isset($default['category']) ? $default['category'] : '', $js); ?> &nbsp; <br /> </td>
					
		        <td> <label for="tname"> Desc </label> <br /> <input type="text" name="tname" size="35" title="Desc" /> &nbsp; </td> 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("costs/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
