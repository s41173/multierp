...
<style media="all">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                { text: 'No', dataField: 'No', width: 50 },
  				{ text: 'Employee', dataField: 'Employee', width : 250 },
				{ text: 'Department', dataField: 'Department', width : 200 },
				{ text: 'Worked Hours', dataField: 'Worked Hours', cellsalign: 'center' },
				{ text: 'Experience', dataField: 'Experience', cellsalign: 'center' }
                ]
            });
		...
		$("#bexport").click(function() {
			...
			var type = $("#crtype").val();	
			if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Honor-Absence'); }
			else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Honor-Absence'); }
			else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Honor-Absence'); }
			else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Honor-Absence'); }
		})	
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <p style="text-align:center; font-size:14pt; font-weight:bold;"> Honor Employee Attendance </p>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; ">
		...
		<table id="table" border="0" width="100%">
           ...
           <thead>
           <tr>
  	       <th> No </th> <th> Employee </th> <th> Department </th> <th> Worked Hours </th> <th> Experience </th>
		   </tr>
           </thead>
			  ...
			  if ($results)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\" align=\"center\">".dept($res->dept)."</td>
					   <td class=\"strongs\" align=\"center\">".$res->hours."</td>
