...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Import - Honor Employee Attendance </legend>
    <table>
     
	<form name="modul_form" id="form" class="myform" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data">	
         
         <tr>
         <td> <label for="userfile"> CSV - File </label> </td>  <td>:</td>
         <td> <input class="" type="file" name="userfile" size="20" title="CSV File" /> <br>
         <p class="error"> <?php echo $error; ?> </p> </td>
         </tr>
