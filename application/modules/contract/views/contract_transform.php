		...
		<table>
			<tr>
				<td>  
					...
					<?php $js = 'class="required"'; echo form_dropdown('cpart', $phase, isset($default['phase']) ? $default['phase'] : '', $js); ?> &nbsp;
				</td>
				
				<td>  
					<label for="tpartdate"> Date : </label> <br />
					<input type="Text" name="tpartdate" id="d4" title="Part date" size="10" class="required" /> 
