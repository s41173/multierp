...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					...
					<td> <label for="tname"> CO-00 : </label> <br /> <input type="text" class="" id="tno" name="tno" size="5" title="No" 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("contract/add"), 'CREATE NEW', $atts); ?> 
           <?php echo anchor_popup(site_url("contract/report"), 'REPORT', $atts2); ?>
           <?php echo anchor_popup(site_url("contract/receivable"), 'RECEIVABLE CARD', $atts2); ?>
           </td> 
		</tr>
	</tbody>
	</table>
    ...
    <fieldset class="field"> <legend> Contract Order - Chart </legend>
		
		<form name="search_form" class="myform" method="post" action="<?php echo ! empty($form_action_graph) ? $form_action_graph : ''; ?>">
			<table>
				<tr> <td> <label for="tname"> Type : </label> <br /> <select name="ctype"> <option value="0"> Amount </option> <option value="1"> Balance </option> </select> &nbsp; </td> 
				     <td> <label for="tname"> Year : </label> <br /> <input type="text" name="tyear" id="tyear" size="4" /> </td> 
