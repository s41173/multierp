...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Vinyl - Purchasing </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" >
	     ...
	     <td> <input type="text" class="required" readonly="readonly" name="tuser" size="15" title="User" value="<?php echo isset($user) ? $user : ''; ?>" /> &nbsp; <br /> </td>
                    ...
                    <tr> 
						...
						<td> <input type="text" class="required" name="tsales" id="titem" size="5" title="Name" /> &nbsp; 
						<?php echo anchor_popup(site_url("sales/get_list/"), '[ ... ]', $atts1); ?>
                        </td>
					</tr>
                    
                     <tr> 
						<td> </td> <td>:</td>
						<td> <textarea name="tremarks" class="required" title="Sales-Remarks" cols="45" rows="3"></textarea> &nbsp; </td>
					</tr>
