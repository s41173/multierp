            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Stock-IN', datafield: 'Stock-IN', width: 160, cellsalign: 'center'},
  				  { text: 'Sales', datafield: 'Sales', width: 160, cellsalign: 'center'},
				  { text: 'Remarks', datafield: 'Remarks', width: 160, cellsalign: 'center'}
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Printing Order Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
		  ...
		  <?php 
			  ...
			  {
				 $res = new Sales_lib();
				 if ($sid > 0){ return 'SO-00'.$res->get_so_no($sid); }else { return '-'; }
			  }
			  ...
			  if ($purchases)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\" align=\"center\">".sales($purchase->sid)."</td>
					   <td class=\"strongs\" align=\"center\">".$purchase->remarks."</td> 
				   </tr>";
				   $i++;
				}
			  }  
