...
<div id="webadmin">
	...
	<fieldset class="field" style="float:left;"> <legend> Printing Order </legend>
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
				<table>
					...
					<tr>	
						<td> <label for="tno"> No - CP-00 </label> </td> <td>:</td>
...
<td> <textarea name="tdesc" class="required" title="Description" cols="45" rows="3"><?php echo set_value('tdesc', isset($default['desc']) ? $default['desc'] : ''); ?></textarea> &nbsp; <br /> </td>
        </tr>	
         
            <tr> 
                <td> <label for="tvendor"> Sales No </label> </td> <td>:</td>
                <td> <input type="text" class="required" name="tsales" id="titem" readonly size="5" title="Name"
             ...
             <tr> 
                <td> </td> <td>:</td>
                <td> <textarea name="tremarks" class="required" title="Sales-Remarks" readonly cols="45" rows="3"><?php echo set_value('tremarks', isset($default['remarks']) ? $default['remarks'] : ''); ?></textarea> &nbsp; </td>
            </tr>           
		...
		<table>
			<tr>
				...
				<td> <label for="tproduct"> Product </label>  <br />
                	 <textarea name="titem" rows="2" cols="45"></textarea> &nbsp; </td>
