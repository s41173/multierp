...
<style media="all">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
			...
			$('#jqxgrid').jqxGrid({ pagesizeoptions: ['100', '500', '1000', '2000', '3000']}); 
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Printing Order Item - Report </h4>
	   </div>
	</center>
			  ...
			  if ($item)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\"> CP-00".$purchase->no."</td> 
					   <td class=\"strongs\">".$purchase->prefix.' '.$purchase->name."</td> 
					   <td class=\"strongs\">".$purchase->product."</td> 
					   ...
					   <td class=\"strongs\" align=\"right\">".status($purchase->status)."</td> 
				   </tr>";
				   $i++;
				}
			  }  
