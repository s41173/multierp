...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Printing Order </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
					
					<td> <label for="tname">NO : CP-00</label> <br /> <input type="text" class="" id="tno" name="tno" size="8" title="No" 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("vinyl/add"), 'CREATE NEW', $atts); ?>
		   <?php echo anchor(site_url("ap_payment"), 'AP - PAYMENT', $atts); ?>
		   <?php echo anchor_popup(site_url("vinyl/report"), 'PRINTING REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
    
     <fieldset class="field"> <legend> Printing Order - Chart </legend>
