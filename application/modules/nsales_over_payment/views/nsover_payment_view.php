...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Non Tax SO - Payment Over </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
					<tr> 
					
					<td> <label for="tcustomer"> Customer </label> <br />
					    <input type="text" class="" name="tcustomer" id="tcust" size="35" title="Name" /> &nbsp; 
...
<div id="webadmin2">
	...
	<tbody>
		<tr> 
		   <td align="right"> 
		   <?php echo anchor_popup(site_url("nsales_over_payment/report"), 'REPORT', $atts2); ?>
		   </td> 
		</tr>
	</tbody>
	</table>
